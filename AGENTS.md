...
- 📐 **[.agents/formatting_rules.md](file:///C:/Users/GlobE/Desktop/Docencia%20Icesi/skill-slides/.agents/formatting_rules.md)**: Manual detailing safe text bounding boxes for each slide layout in CSS/px units.

### 3. Composition Skills
Review the interactive guide to composing new slides using `icesibeamer.js` component functions at:
- 🛠️ **[.agents/skills/generate-slides/SKILL.md](file:///C:/Users/GlobE/Desktop/Docencia%20Icesi/skill-slides/.agents/skills/generate-slides/SKILL.md)**: Guidelines on structured HTML frame composition and content flow using Reveal.js.
...
1. **Exclusive Use of Component Library**:
   - Every slide in [main.html](file:///C:/Users/GlobE/Desktop/Docencia%20Icesi/skill-slides/main.html) or `slides/<tema>/<tema>.html` must use the functions defined in [icesibeamer.js](file:///C:/Users/GlobE/Desktop/Docencia%20Icesi/skill-slides/icesibeamer.js) (`icesi.titleSlideA()`, `icesi.slideStandard()`, etc.) or the CSS classes from [icesibeamer.css](file:///C:/Users/GlobE/Desktop/Docencia%20Icesi/skill-slides/icesibeamer.css) directly.
   - **Do not write ad-hoc inline styles directly on slide HTML**. Any new visual component must be added to `icesibeamer.css` and `icesibeamer.js` first before being used in a presentation file.
2. **Typography and Images**:
   - Primary typeface: **Plus Jakarta Sans** (loaded locally via `@font-face` in `icesibeamer.css` from `resources/fonts/`).
...
3. **Reveal.js Initialization**:
   ...
   - Mermaid.js must also be loaded from CDN before `icesibeamer.js` is called.
